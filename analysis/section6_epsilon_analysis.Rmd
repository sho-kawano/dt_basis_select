...
p_a <- ggplot(mae_data, aes(epsilon, mae,
  ...
  labs(title = "(a) Mean absolute error of selected number of basis functions",
...
p_b <- ggplot(bias_data, aes(epsilon, mean_bias,
  ...
  scale_color_brewer(palette = "Set1", name = "R") +
  scale_fill_brewer(palette = "Set1", name = "R") +
  labs(title = "(b) Mean bias of selected number of basis functions",
       x = expression(epsilon),
       y = "Mean Bias") +
  theme_minimal() +
  theme(legend.position = "bottom",
